...
* `connections` / `Connections`  (PartnerConnection[]): Approved Connected Sites relationships for this Partner, in both directions. Empty when this Partner has no connections. Read-only.
