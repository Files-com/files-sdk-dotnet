...
* `created_by_sync_id` / `CreatedBySyncId`  (Nullable<Int64>): ID of the Sync that created the file/folder
...
* `last_modified_by_sync_id` / `LastModifiedBySyncId`  (Nullable<Int64>): ID of the Sync that last modified the file/folder
