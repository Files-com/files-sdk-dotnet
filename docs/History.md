...
```
Task<Export> History.ListForFileCreateExport(
    Nullable<Int64> path, 
    Dictionary<string, object> parameters = null,
    Dictionary<string, object> options = null
)
...
```
Task<Export> History.ListForFolderCreateExport(
    Nullable<Int64> path, 
    Dictionary<string, object> parameters = null,
    Dictionary<string, object> options = null
)
...
```
Task<Export> History.ListForUserCreateExport(
    Nullable<Int64> user_id, 
    Dictionary<string, object> parameters = null,
    Dictionary<string, object> options = null
)
...
```
Task<Export> History.ListLoginsCreateExport(
...
```
Task<Export> History.ListCreateExport(
