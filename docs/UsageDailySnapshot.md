...
* `transformation_credits_usage` / `TransformationCreditsUsage`  (Nullable<Int64>): Transformation and AI credits used on this day. Note: only updated for days before the current day.
