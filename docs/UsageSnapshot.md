...
* `transformation_credits_usage` / `TransformationCreditsUsage`  (Nullable<Int64>): Total Transformation and AI credits used in this usage period. Updated daily. Does not include credits consumed today.
