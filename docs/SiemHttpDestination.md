...
* `file_interval_minutes` / `FileIntervalMinutes`  (Nullable<Int64>): Applicable only for destination type: file. Interval, in minutes, between file deliveries.
...
parameters.Add("file_format", "example");
parameters.Add("file_interval_minutes", 1);
