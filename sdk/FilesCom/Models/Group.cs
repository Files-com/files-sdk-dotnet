...
namespace FilesCom.Models
{
    public class Group
    {
        ...
        public async Task<Group> Delete(Dictionary<string, object> parameters)
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/groups/{System.Uri.EscapeDataString(attributes["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/groups/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
