...
namespace FilesCom.Models
{
    public class RemoteBandwidthSnapshot
    {
        ...
        /// </summary>
        public static FilesList<RemoteBandwidthSnapshot> List(
        ...
        )
        {
            ...
            return new FilesList<RemoteBandwidthSnapshot>($"/remote_bandwidth_snapshots", System.Net.Http.HttpMethod.Get, parameters, options);
        }

        public static FilesList<RemoteBandwidthSnapshot> All(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/remote_bandwidth_snapshots/create_export", System.Net.Http.HttpMethod.Post, parameters, options);
