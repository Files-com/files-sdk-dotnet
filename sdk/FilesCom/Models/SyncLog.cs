...
namespace FilesCom.Models
{
    public class SyncLog : IModel
    {
        ...
        public SyncLog(Dictionary<string, object> attributes, Dictionary<string, object> options)
        {
            ...
            if (!this.attributes.ContainsKey("sync_run_id"))
            {
                this.attributes.Add("sync_run_id", null);
            }
        ...
        /// </summary>
        [JsonInclude]
        [JsonPropertyName("sync_run_id")]
        public Nullable<Int64> SyncRunId
        {
            get { return (Nullable<Int64>)attributes["sync_run_id"]; }
            private set { attributes["sync_run_id"] = value; }
        }
