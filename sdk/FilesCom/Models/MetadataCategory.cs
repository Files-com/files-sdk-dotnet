...
namespace FilesCom.Models
{
    public class MetadataCategory
    {
        ...
        public MetadataCategory(Dictionary<string, object> attributes, Dictionary<string, object> options)
        {
            ...
            if (!this.attributes.ContainsKey("definitions"))
            {
                this.attributes.Add("definitions", new Dictionary<string, string[]>());
            }
            if (!this.attributes.ContainsKey("default_columns"))
            {
                this.attributes.Add("default_columns", new string[0]);
            }
        }
        ...
        {
            get { return (Dictionary<string, string[]>)attributes["definitions"]; }
            set { attributes["definitions"] = value; }
        }
        ...
        {
            get { return (string[])attributes["default_columns"]; }
            set { attributes["default_columns"] = value; }
        }
        ...
        public async Task<MetadataCategory> Update(Dictionary<string, object> parameters)
        {
            ...
            if (parameters.ContainsKey("default_columns") && !(parameters["default_columns"] is string[]))
            {
            ...
            try
            {
                return JsonSerializer.Deserialize<MetadataCategory>(responseJson, JsonUtil.Options);
            }
            catch (JsonException)
            {
        ...
        /// </summary>
        public static FilesList<MetadataCategory> List(
        ...
        /// </summary>
        public static FilesList<MetadataCategory> ListFor(
            string path,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
