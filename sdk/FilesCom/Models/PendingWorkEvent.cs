...
{
    public class PendingWorkEvent : IModel
    {
        private Dictionary<string, object> attributes;
        private Dictionary<string, object> options;
        public PendingWorkEvent() : this(null, null) { }

        public PendingWorkEvent(Dictionary<string, object> attributes, Dictionary<string, object> options)
        {
        ...
        /// </summary>
        public static FilesList<PendingWorkEvent> List(
        ...
        )
        {
            ...
            return new FilesList<PendingWorkEvent>($"/pending_work_events", System.Net.Http.HttpMethod.Get, parameters, options);
        }

        public static FilesList<PendingWorkEvent> All(
        ...
        /// </summary>
        public static async Task<PendingWorkEvent> Find(
            Nullable<Int64> id,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/pending_work_events/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);

            try
            {
                return JsonUtil.DeserializeWithOptions<PendingWorkEvent>(responseJson, options);
            }
            catch (JsonException)
            {
        ...
        public static async Task<PendingWorkEvent> Get(
            Nullable<Int64> id,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
