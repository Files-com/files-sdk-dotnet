...
namespace FilesCom.Models
{
    public class Payment
    {
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/payments/{Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
