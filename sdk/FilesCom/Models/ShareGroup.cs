...
{
    public class ShareGroup : IModel
    {
        ...
        public async Task<ShareGroup> Update(Dictionary<string, object> parameters)
        {
            ...
            try
            {
                return JsonUtil.DeserializeWithOptions<ShareGroup>(responseJson, options);
            }
            catch (JsonException)
            {
        ...
        /// </summary>
        public static FilesList<ShareGroup> List(
        ...
        )
        {
            ...
            return new FilesList<ShareGroup>($"/share_groups", System.Net.Http.HttpMethod.Get, parameters, options);
        }

        public static FilesList<ShareGroup> All(
