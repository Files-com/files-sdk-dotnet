...
namespace FilesCom.Models
{
    public class Permission
    {
        ...
        public async Task<Permission> Delete(Dictionary<string, object> parameters)
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/permissions/{System.Uri.EscapeDataString(attributes["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/permissions/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
