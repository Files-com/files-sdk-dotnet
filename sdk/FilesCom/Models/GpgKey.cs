...
namespace FilesCom.Models
{
    public class GpgKey
    {
        ...
        public async Task<GpgKey> Update(Dictionary<string, object> parameters)
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/gpg_keys/{System.Uri.EscapeDataString(attributes["id"].ToString())}", new HttpMethod("PATCH"), parameters, options);
        ...
        /// </summary>
        public static async Task<GpgKey[]> List(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/gpg_keys", System.Net.Http.HttpMethod.Get, parameters, options);

            return JsonSerializer.Deserialize<GpgKey[]>(responseJson);
        }

        public static async Task<GpgKey[]> All(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/gpg_keys/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/gpg_keys", System.Net.Http.HttpMethod.Post, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/gpg_keys/{System.Uri.EscapeDataString(parameters["id"].ToString())}", new HttpMethod("PATCH"), parameters, options);
