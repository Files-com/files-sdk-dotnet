...
namespace FilesCom.Models
{
    public class HistoryExport
    {
        ...
        /// <summary>
        /// Filter results by this this interface type. Valid values: `web`, `ftp`, `robot`, `jsapi`, `webdesktopapi`, `sftp`, `dav`, `desktop`, `restapi`, `scim`, `office`, `mobile`, `as2`
        /// </summary>
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/history_exports/{Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
