...
namespace FilesCom.Models
{
    public class History
    {
        ...
        ///   path (required) - int64
        /// </summary>
        public static async Task<Export> ListForFileCreateExport(
            Nullable<Int64> path,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        {
            ...
            if (parameters.ContainsKey("path") && !(parameters["path"] is Nullable<Int64>))
            {
                throw new ArgumentException("Bad parameter: path must be of type Nullable<Int64>", "parameters[\"path\"]");
            }

            string responseJson = await FilesClient.SendStringRequest($"/history/files/{System.Uri.EscapeDataString(parameters["path"].ToString())}/create_export", System.Net.Http.HttpMethod.Post, parameters, options);
        ...
        ///   path (required) - int64
        /// </summary>
        public static async Task<Export> ListForFolderCreateExport(
            Nullable<Int64> path,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/history/folders/{System.Uri.EscapeDataString(parameters["path"].ToString())}/create_export", System.Net.Http.HttpMethod.Post, parameters, options);
        ...
        ///   user_id (required) - int64 - User ID.
        /// </summary>
        public static async Task<Export> ListForUserCreateExport(
            Nullable<Int64> user_id,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/history/users/{System.Uri.EscapeDataString(parameters["user_id"].ToString())}/create_export", System.Net.Http.HttpMethod.Post, parameters, options);
        ...
        ///   sort_by - object - If set, sort records by the specified field in either `asc` or `desc` direction. Valid fields are `created_at`.
        /// </summary>
        public static async Task<Export> ListLoginsCreateExport(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/history/login/create_export", System.Net.Http.HttpMethod.Post, parameters, options);
        ...
        ///   filter_prefix - object - If set, return records where the specified field is prefixed by the supplied value. Valid fields are `path`.
        /// </summary>
        public static async Task<Export> ListCreateExport(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/history/create_export", System.Net.Http.HttpMethod.Post, parameters, options);
