...
namespace FilesCom.Models
{
    public class Snapshot
    {
        ...
        /// </summary>
        public static FilesList<Snapshot> List(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/snapshots/create_export", System.Net.Http.HttpMethod.Post, parameters, options);
