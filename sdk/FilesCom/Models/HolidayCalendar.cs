...
namespace FilesCom.Models
{
    public class HolidayCalendar : IModel
    {
        ...
        public async Task<HolidayCalendar> Update(Dictionary<string, object> parameters)
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/holiday_calendars/{System.Uri.EscapeDataString(attributes["id"].ToString())}", new HttpMethod("PATCH"), parameters, options);

            try
            {
                return JsonUtil.DeserializeWithOptions<HolidayCalendar>(responseJson, options);
            }
            catch (JsonException)
            {
        ...
        public async Task Delete(Dictionary<string, object> parameters)
        {
            ...
            await FilesClient.SendRequest($"/holiday_calendars/{System.Uri.EscapeDataString(attributes["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        }
        ...
        public async Task Save()
        {
            ...
            {
                var newObj = await HolidayCalendar.Create(this.attributes, this.options);
        ...
        )
        {
            ...
            return new FilesList<HolidayCalendar>($"/holiday_calendars", System.Net.Http.HttpMethod.Get, parameters, options);
        }
        ...
        /// </summary>
        public static async Task<HolidayCalendar> Find(
            Nullable<Int64> id,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/holiday_calendars/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
        ...
        public static async Task<HolidayCalendar> Get(
            Nullable<Int64> id,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/holiday_calendars", System.Net.Http.HttpMethod.Post, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/holiday_calendars/{System.Uri.EscapeDataString(parameters["id"].ToString())}", new HttpMethod("PATCH"), parameters, options);
        ...
        )
        {
            ...
            await FilesClient.SendRequest($"/holiday_calendars/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        }
