...
namespace FilesCom.Models
{
    public class EventChannel
    {
        ...
        /// </summary>
        public async Task<EventChannel> Update(Dictionary<string, object> parameters)
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/event_channels/{System.Uri.EscapeDataString(attributes["id"].ToString())}", new HttpMethod("PATCH"), parameters, options);

            try
            {
                return JsonSerializer.Deserialize<EventChannel>(responseJson, JsonUtil.Options);
            }
            catch (JsonException)
            {
        ...
        public async Task Delete(Dictionary<string, object> parameters)
        {
            ...
            await FilesClient.SendRequest($"/event_channels/{System.Uri.EscapeDataString(attributes["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        }
        ...
        public async Task Save()
        {
            ...
            {
                var newObj = await EventChannel.Create(this.attributes, this.options);
        ...
        )
        {
            ...
            return new FilesList<EventChannel>($"/event_channels", System.Net.Http.HttpMethod.Get, parameters, options);
        }
        ...
        /// </summary>
        public static async Task<EventChannel> Find(
            Nullable<Int64> id,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/event_channels/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
        ...
        public static async Task<EventChannel> Get(
            Nullable<Int64> id,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        ...
        ///   default_channel - boolean - Whether this Event Channel is the default destination for newly published events.
        /// </summary>
        public static async Task<EventChannel> Create(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/event_channels", System.Net.Http.HttpMethod.Post, parameters, options);
        ...
        ///   default_channel - boolean - Whether this Event Channel is the default destination for newly published events.
        /// </summary>
        public static async Task<EventChannel> Update(
            Nullable<Int64> id,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/event_channels/{System.Uri.EscapeDataString(parameters["id"].ToString())}", new HttpMethod("PATCH"), parameters, options);
        ...
        )
        {
            ...
            await FilesClient.SendRequest($"/event_channels/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        }
