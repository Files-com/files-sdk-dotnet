...
namespace FilesCom.Models
{
    public class ActionNotificationExport
    {
        ...
        public ActionNotificationExport(Dictionary<string, object> attributes, Dictionary<string, object> options)
        {
            ...
            {
                this.attributes.Add("query_success", null);
            }
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/action_notification_exports/{Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
