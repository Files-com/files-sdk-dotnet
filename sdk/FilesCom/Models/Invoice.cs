...
namespace FilesCom.Models
{
    public class Invoice
    {
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/invoices/{Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
