...
namespace FilesCom.Models
{
    public class Export
    {
        ...
        public Export() : this(null, null) { }

        public Export(Dictionary<string, object> attributes, Dictionary<string, object> options)
        {
            ...
            if (!this.attributes.ContainsKey("export_status"))
            {
                this.attributes.Add("export_status", null);
            }
        ...
        /// </summary>
        public static FilesList<Export> List(
        ...
        )
        {
            ...
            return new FilesList<Export>($"/exports", System.Net.Http.HttpMethod.Get, parameters, options);
        }

        public static FilesList<Export> All(
        ...
        /// </summary>
        public static async Task<Export> Find(
            Nullable<Int64> id,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/exports/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
        ...
        public static async Task<Export> Get(
            Nullable<Int64> id,
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
