...
namespace FilesCom.Models
{
    public class MessageReaction
    {
        ...
        public MessageReaction() : this(null, null) { }
        ...
        public async Task Delete(Dictionary<string, object> parameters)
        {
            ...
            await FilesClient.SendRequest($"/message_reactions/{System.Uri.EscapeDataString(attributes["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        }
        ...
        public async Task Save()
        {
            ...
            {
                var newObj = await MessageReaction.Create(this.attributes, this.options);
        ...
        /// </summary>
        public static FilesList<MessageReaction> List(
        ...
        )
        {
            ...
            return new FilesList<MessageReaction>($"/message_reactions", System.Net.Http.HttpMethod.Get, parameters, options);
        }

        public static FilesList<MessageReaction> All(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/message_reactions/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/message_reactions", System.Net.Http.HttpMethod.Post, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/message_reactions/create_export", System.Net.Http.HttpMethod.Post, parameters, options);
        ...
        )
        {
            ...
            await FilesClient.SendRequest($"/message_reactions/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        }
