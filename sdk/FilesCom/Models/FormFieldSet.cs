...
namespace FilesCom.Models
{
    public class FormFieldSet
    {
        ...
        public async Task<FormFieldSet> Update(Dictionary<string, object> parameters)
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/form_field_sets/{System.Uri.EscapeDataString(attributes["id"].ToString())}", new HttpMethod("PATCH"), parameters, options);
        ...
        public async Task<FormFieldSet> Delete(Dictionary<string, object> parameters)
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/form_field_sets/{System.Uri.EscapeDataString(attributes["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/form_field_sets/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/form_field_sets/{System.Uri.EscapeDataString(parameters["id"].ToString())}", new HttpMethod("PATCH"), parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/form_field_sets/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
