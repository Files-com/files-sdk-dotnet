...
namespace FilesCom.Models
{
    public class FormFieldSet
    {
        ...
        public FormFieldSet(Dictionary<string, object> attributes, Dictionary<string, object> options)
        {
            ...
            {
                this.attributes.Add("form_fields", new object[0]);
            }
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendStringRequest($"/form_field_sets/create_export", System.Net.Http.HttpMethod.Post, parameters, options);
