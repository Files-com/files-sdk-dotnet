...
{
    public class MessageComment : IModel
    {
        ...
        public MessageComment(Dictionary<string, object> attributes, Dictionary<string, object> options)
        {
            ...
            {
                this.attributes.Add("reactions", new MessageCommentReaction[0]);
            }
        ...
        public async Task<MessageComment> Update(Dictionary<string, object> parameters)
        {
            ...
            try
            {
                return JsonUtil.DeserializeWithOptions<MessageComment>(responseJson, options);
            }
            catch (JsonException)
            {
        ...
        public async Task Delete(Dictionary<string, object> parameters)
        {
            ...
            await FilesClient.SendRequest($"/message_comments/{System.Uri.EscapeDataString(attributes["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        }
        ...
        )
        {
            ...
            await FilesClient.SendRequest($"/message_comments/{System.Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        }
