...
namespace FilesCom.Models
{
    public class MessageComment
    {
        ...
        {
            get { return (MessageCommentReaction) attributes["reactions"]; }
        ...
        public async Task<MessageComment> Update(Dictionary<string, object> parameters)
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/message_comments/{Uri.EscapeDataString(attributes["id"].ToString())}", new HttpMethod("PATCH"), parameters, options);
        ...
        public async Task<MessageComment> Delete(Dictionary<string, object> parameters)
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/message_comments/{Uri.EscapeDataString(attributes["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
        ...
        public async Task Save()
        {
            ...
            {
                var newObj = await MessageComment.Create(this.attributes, this.options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/message_comments/{Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Get, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/message_comments/{Uri.EscapeDataString(parameters["id"].ToString())}", System.Net.Http.HttpMethod.Delete, parameters, options);
