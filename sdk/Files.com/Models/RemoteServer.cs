...
namespace Files.Models
{
    public class RemoteServer
    {
        ...
        /// </summary>
        public static async Task<RemoteFile> ListForTesting(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/remote_servers/list_for_testing", System.Net.Http.HttpMethod.Get, parameters, options);
