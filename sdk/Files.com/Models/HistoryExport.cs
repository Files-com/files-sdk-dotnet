...
namespace Files.Models
{
    public class HistoryExport
    {
        ...
        public async Task<HistoryExport> Delete(Dictionary<string, object> parameters)
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/history_exports/{attributes["id"]}", System.Net.Http.HttpMethod.Delete, parameters, options);
        ...
        /// </summary>
        public static async Task<HistoryExport[]> List(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/history_exports", System.Net.Http.HttpMethod.Get, parameters, options);

            return JsonSerializer.Deserialize<HistoryExport[]>(responseJson);
        }

        public static async Task<HistoryExport[]> All(
        ...
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/history_exports/{parameters["id"]}", System.Net.Http.HttpMethod.Get, parameters, options);
        ...
        /// <summary>
        /// </summary>
        public static async Task<HistoryExport> Delete(
            Nullable<Int64> id, 
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
        {
            ...
            string responseJson = await FilesClient.SendRequest($"/history_exports/{parameters["id"]}", System.Net.Http.HttpMethod.Delete, parameters, options);

            return JsonSerializer.Deserialize<HistoryExport>(responseJson);
        }

        public static async Task<HistoryExport> Destroy(
            Nullable<Int64> id, 
            Dictionary<string, object> parameters = null,
            Dictionary<string, object> options = null
        )
